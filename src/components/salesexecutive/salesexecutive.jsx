...
const StaffManage = () => {
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await axios.post(`${apiUrl}/salespersons`, payload);
    ...
    const handleUpdate = async () => {
        try {
            ...
            const response = await axios.put(
                `${apiUrl}/salespersons/${selectedPerson._id}`,  // Ensure the ID is passed correctly
                payload
            );
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`${apiUrl}/salespersons/${id}`);
                        ...
                        {salesPersons.map((value, index) => (
                            <tr className="hover:bg-gray-100" key={index}>
                                ...
                                <td className="px-4 py-2 border border-gray-300 text-center">
                                    <button
                                        className="p-2 w-32 h-10 font-bold text-md bg-teal-600 text-white rounded-md hover:bg-teal-700 focus:outline-none"
