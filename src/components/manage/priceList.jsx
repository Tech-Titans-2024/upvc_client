              ...
              products.map((product, index) => (
                <tr key={index} className="hover:bg-gray-100">
                  ...
                  <td className="px-4 py-2 border border-gray-300 text-center">
                    <button className="px-3 py-1 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none">
                      Edit
                    </button>
                    <button className="px-3 py-1 ml-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none">
                      Delete
                    </button>
                  </td>
                </tr>
